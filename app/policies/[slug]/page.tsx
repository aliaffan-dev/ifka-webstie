...
const tabs: { key: PolicyKey; label: string; slug: string }[] = [
  { key: "membership",  label: "Membership",          slug: "membership" },
  { key: "attendance",  label: "Attendance",           slug: "attendance" },
  { key: "safety",      label: "Safety Guidelines",    slug: "safety-guidelines" },
  { key: "conduct",     label: "Code of Conduct",      slug: "code-of-conduct" },
  { key: "uniform",     label: "Uniform",              slug: "uniform" },
  { key: "payment",     label: "Payment",              slug: "payment" },
  { key: "refund",      label: "Refund & Cancellation",slug: "refund-cancellation" },
...
export default function PolicySlugPage() {
  ...
  const current = policies[activeTab.key];
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-3">
            {tabs.map((tab, i) => {
              ...
              return (
                <AccordionItem key={tab.key} title={p.title} defaultOpen={tab.slug === slug}>
